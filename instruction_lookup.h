...
{NOP, nop, {0,0}, 1, 4}, {LXI, lxi, {B,0}, 3, 10}, {STAX, stax, {B, 0}, 1, 7}, {INX, inx, {B, 0}, 1, 5},  //0x
...
{NOP, nop, {0,0}, 1, 4}, {LXI, lxi, {D,0}, 3, 10}, {STAX, stax, {D, 0}, 1, 7}, {INX, inx, {D, 0}, 1, 5},  //1x
...
{NOP, nop, {0,0}, 1, 4}, {LXI, lxi, {H,0}, 3, 10}, {SHLD, shld, {0, 0}, 3, 16}, {INX, inx, {H, 0}, 1, 5},  //2x
...
{NOP, nop, {0,0}, 1, 4}, {LXI, lxi, {SP,0}, 3, 10}, {STA, sta, {0, 0}, 3, 13}, {INX, inx, {SP, 0}, 1, 5},  //3x
{INR, inr, {M, 0}, 1, 10}, {DCR, dcr, {M, 0}, 1, 10}, {MVI, mvi, {M,0}, 2, 10}, {STC, stc, {0,0}, 1, 4},
...
{MOV, mov, {B,B}, 1, 5}, {MOV, mov, {B,C}, 1, 5},{MOV, mov, {B,D}, 1, 5},{MOV, mov, {B,E}, 1, 5}, // 4x
...
{MOV, mov, {D,B}, 1, 5}, {MOV, mov, {D,C}, 1, 5},{MOV, mov, {D,D}, 1, 5},{MOV, mov, {D,E}, 1, 5}, //5x
...
{MOV, mov, {H,B}, 1, 5}, {MOV, mov, {H,C}, 1, 5},{MOV, mov, {H,D}, 1, 5},{MOV, mov, {H,E}, 1, 5}, //6x
...
{MOV, mov, {M,B}, 1, 7}, {MOV, mov, {M,C}, 1, 7},{MOV, mov, {M,D}, 1, 7},{MOV, mov, {M,E}, 1, 7}, //7x
...
{ADD, add, {B, 0}, 1, 4}, {ADD, add, {C, 0}, 1, 4}, {ADD, add, {D, 0}, 1, 4}, {ADD, add, {E, 0}, 1, 4}, //8x
...
{SUB, sub, {B, 0}, 1, 4}, {SUB, sub, {C, 0}, 1, 4}, {SUB, sub, {D, 0}, 1, 4}, {SUB, sub, {E, 0}, 1, 4}, //9x
...
{ANA, ana, {B, 0}, 1, 4}, {ANA, ana, {C, 0}, 1, 4}, {ANA, ana, {D, 0}, 1, 4}, {ANA, ana, {E, 0}, 1, 4}, //ax
...
{ORA, ora, {B, 0}, 1, 4}, {ORA, ora, {C, 0}, 1, 4}, {ORA, ora, {D, 0}, 1, 4}, {ORA, ora, {E, 0}, 1, 4}, //bx
...
{RNZ, rnz, {0,0}, 1, 11}, {POP, pop, {B,0}, 1, 10}, {JNZ, jnz, {0,0}, 3, 10}, {JMP, jmp, {0,0}, 3, 10}, //cx
...
{RNC, rnc, {0,0}, 1, 11}, {POP, pop, {D,0}, 1, 10}, {JNC, jnc, {0,0}, 3, 10}, {OUT, out_inst, {0,0}, 2, 10}, //dx
...
{RPO, rpo, {0,0}, 1, 11}, {POP, pop, {H,0}, 1, 10}, {JPO, jpo, {0,0}, 3, 10}, {XTHL, xthl, {0,0}, 1, 18}, //ex
